...
\centering
\small
\caption{Attention configurations profiled.  DS-V2-Lite is used only for perplexity evaluation; reconstruction timing uses DeepSeek-V3 shapes ($H{=}128$).}
\label{tab:configs}
...
\begin{groupplot}[
  ...
  extra y tick labels={},
  extra y tick style={grid style={black!50, thick, dashed}},
  legend style={font=\tiny, at={(0.5,1.28)}, anchor=south, legend columns=2, /tikz/every even column/.append style={column sep=5pt}},
]
